<?php
// File: C:\xampp\htdocs\pllcg82\user\ebikes.php
...
// Build query for E-Bikes only
$where_conditions = ["is_available = 1", "category = 'ebikes'"];
$params = [];

// Subcategory filter (model)
...
// Get all unique subcategories (models) for e-bikes
$subcategory_stmt = $pdo->query("SELECT DISTINCT subcategory, COUNT(*) as count FROM products WHERE category = 'ebikes' AND is_available = 1 GROUP BY subcategory ORDER BY subcategory");
$subcategories = $subcategory_stmt->fetchAll();

// Get price statistics for e-bikes
$price_stats = $pdo->query("SELECT MIN(price) as min_price, MAX(price) as max_price, AVG(price) as avg_price FROM products WHERE category = 'ebikes' AND is_available = 1")->fetch();

// ========== SEO META TAGS ==========
$page_title = "Premium Electric Bikes | E-Bikes Collection | PLLC Enterprise";
$page_description = "Shop our premium collection of electric bikes including Raven, Echo, Supreme, Skye, and more. High-quality e-bikes with long-lasting batteries. Free shipping on orders over ₱10,000!";
$page_keywords = "e-bikes, electric bicycles, Raven e-bike, Echo e-bike, Supreme e-bike, electric bike Philippines, PLLC Enterprise";

if (!empty($subcategory) && $subcategory != 'all') {
    $subcategory_name = ucfirst($subcategory);
    $page_title = "$subcategory_name E-Bike | Premium Electric Bike | PLLC Enterprise";
    $page_description = "Discover the $subcategory_name electric bike from PLLC Enterprise. High-performance e-bike with advanced features and long-lasting battery. Shop now!";
}
...
<head>
    ...
    <meta property="og:image" content="https://yourdomain.com/image/og-ebikes.jpg">
    <meta property="og:url" content="https://yourdomain.com/user/ebikes.php">
    ...
    <!-- Canonical URL -->
    <link rel="canonical" href="https://yourdomain.com/user/ebikes.php<?php echo !empty($_SERVER['QUERY_STRING']) ? '?' . htmlspecialchars($_SERVER['QUERY_STRING']) : ''; ?>">
...
<body>
    ...
    <main class="main-content">
        <div class="products-page">
            <div class="breadcrumb">
                ...
                <span>E-Bikes</span>
                <?php if(!empty($subcategory) && $subcategory != 'all'): ?> > <span><?php echo htmlspecialchars(ucfirst($subcategory)); ?></span><?php endif; ?>
            </div>
            ...
            <div class="active-filters">
                ...
                <span class="filter-tag">
                    <i class="fas fa-tag"></i> Model: <?php echo htmlspecialchars(ucfirst($subcategory)); ?>
            ...
            <div class="products-layout">
                ...
                <aside class="filters-sidebar">
                    <h3><i class="fas fa-filter"></i> Filter by Model</h3>
                    <div class="filter-group" id="modelFilters">
                        <label class="filter-option">
                            <input type="radio" name="model_radio" value="all" class="model-radio" <?php echo empty($subcategory) ? 'checked' : ''; ?>>
                            <span>All Models</span>
                            <span class="count">(<?php echo $total_products; ?>)</span>
                        </label>
                        <?php foreach($subcategories as $cat): ?>
                        <label class="filter-option">
                            <input type="radio" name="model_radio" value="<?php echo htmlspecialchars($cat['subcategory']); ?>" class="model-radio" <?php echo $subcategory == $cat['subcategory'] ? 'checked' : ''; ?>>
                            <span><?php echo ucfirst(htmlspecialchars($cat['subcategory'])); ?></span>
                    ...
                    <div class="clear-filters">
                        <a href="ebikes.php"><i class="fas fa-times-circle"></i> Clear All Filters</a>
                    </div>
                </aside>
                ...
                <div class="products-content">
                    <div class="products-header">
                        <div>
                            <h1><i class="fas fa-bicycle"></i> <?php 
                                if(!empty($subcategory) && $subcategory != 'all') {
                                    echo htmlspecialchars(ucfirst($subcategory)) . " E-Bikes";
                                } else {
                                    echo "All E-Bikes";
                                }
                            ?></h1>
                            <div class="products-count">
                                <i class="fas fa-box"></i> Showing <?php echo count($products); ?> of <?php echo $total_products; ?> electric bikes
                            </div>
                        </div>
                    ...
                    <div class="products-grid">
                        ...
                        <?php else: ?>
                            <div class="no-products">
                                ...
                                <h3>No e-bikes found</h3>
                                <p>Try adjusting your filters or check back later for new arrivals</p>
                                <a href="ebikes.php" class="apply-filter-btn" style="display: inline-block; width: auto; padding: 10px 20px; margin-top: 20px;">Clear Filters</a>
                            </div>
                        <?php endif; ?>
                    </div>
    ...
    <script>
    // Model filter handling with radio buttons
