<?php
// File: C:\xampp\htdocs\pllcg82\user\battery.php
...
// Build query for Batteries only
$where_conditions = ["is_available = 1", "category = 'batteries'"];
$params = [];

// Subcategory filter (battery type)
...
// Get all unique subcategories (battery types) for batteries
$subcategory_stmt = $pdo->query("SELECT DISTINCT subcategory, COUNT(*) as count FROM products WHERE category = 'batteries' AND is_available = 1 GROUP BY subcategory ORDER BY subcategory");
$subcategories = $subcategory_stmt->fetchAll();

// Get price statistics for batteries
$price_stats = $pdo->query("SELECT MIN(price) as min_price, MAX(price) as max_price, AVG(price) as avg_price FROM products WHERE category = 'batteries' AND is_available = 1")->fetch();

// ========== SEO META TAGS ==========
$page_title = "Premium E-Bike Batteries | High-Performance Power Solutions | PLLC Enterprise";
$page_description = "Shop our premium collection of e-bike batteries including 48V, 60V, Lithium Pro, and Heavy Duty options. Long-lasting power solutions with warranty. Free shipping on orders over ₱10,000!";
$page_keywords = "e-bike batteries, 48V battery, 60V battery, lithium battery, e-bike power supply, PLLC Enterprise, electric bike battery";

if (!empty($subcategory) && $subcategory != 'all') {
    $subcategory_name = ucfirst(str_replace('-', ' ', $subcategory));
    $page_title = "$subcategory_name Battery | Premium E-Bike Battery | PLLC Enterprise";
    $page_description = "Discover the $subcategory_name battery from PLLC Enterprise. High-performance power solution for your electric bike with long-lasting durability. Shop now!";
}
...
<head>
    ...
    <meta property="og:image" content="https://yourdomain.com/image/og-batteries.jpg">
    <meta property="og:url" content="https://yourdomain.com/user/battery.php">
    ...
    <!-- Canonical URL -->
    <link rel="canonical" href="https://yourdomain.com/user/battery.php<?php echo !empty($_SERVER['QUERY_STRING']) ? '?' . htmlspecialchars($_SERVER['QUERY_STRING']) : ''; ?>">
    ...
    <script type="application/ld+json">
    {
        ...
        "itemListElement": [
            ...
            foreach($products as $product):
                $item_count++;
                $image_url = !empty($product['image']) ? "https://yourdomain.com/" . $product['image'] : "https://yourdomain.com/image/placeholder-battery.jpg";
            ?>
            {
                "@type": "ListItem",
        ...
        <div class="products-page">
            ...
            <div class="active-filters">
                ...
                <span class="filter-tag">
                    <i class="fas fa-battery-full"></i> Type: <?php 
                        $type_name = ucfirst(str_replace('-', ' ', $subcategory));
                        if(strpos($subcategory, '48v') !== false) echo "48V Battery";
                        elseif(strpos($subcategory, '60v') !== false) echo "60V Battery";
                        elseif(strpos($subcategory, 'lithium') !== false) echo "Lithium Pro";
                        elseif(strpos($subcategory, 'heavy') !== false) echo "Heavy Duty";
                        else echo $type_name;
                    ?>
            ...
            <div class="products-layout">
                ...
                <aside class="filters-sidebar">
                    <h3><i class="fas fa-battery-full"></i> Filter by Type</h3>
                        ...
                        <label class="filter-option">
                            ...
                            <span>
                                <?php 
                                    ...
                                    if(strpos($cat['subcategory'], '48v') !== false) echo "🔋 48V Battery";
                                    elseif(strpos($cat['subcategory'], '60v') !== false) echo "⚡ 60V Battery";
                                    elseif(strpos($cat['subcategory'], 'lithium') !== false) echo "🔋 Lithium Pro";
                                    elseif(strpos($cat['subcategory'], 'heavy') !== false) echo "💪 Heavy Duty";
                                    else echo $type_name;
                                ?>
                            </span>
                    ...
                    <div class="clear-filters">
                        <a href="battery.php"><i class="fas fa-times-circle"></i> Clear All Filters</a>
                    </div>
                </aside>
                ...
                <div class="products-content">
                    <div class="products-header">
                        <div>
                            <h1><i class="fas fa-battery-full"></i> <?php 
                                if(!empty($subcategory) && $subcategory != 'all') {
                                    $type_name = ucfirst(str_replace('-', ' ', $subcategory));
                                    if(strpos($subcategory, '48v') !== false) echo "48V Batteries";
                                    elseif(strpos($subcategory, '60v') !== false) echo "60V Batteries";
                                    elseif(strpos($subcategory, 'lithium') !== false) echo "Lithium Pro Batteries";
                                    elseif(strpos($subcategory, 'heavy') !== false) echo "Heavy Duty Batteries";
                                    else echo $type_name . " Batteries";
                                } else {
                                    echo "All Batteries";
                                }
                            ?></h1>
                            <div class="products-count">
                                <i class="fas fa-box"></i> Showing <?php echo count($products); ?> of <?php echo $total_products; ?> power solutions
                            </div>
                        </div>
                    ...
                    <div class="products-grid">
                        <?php if(count($products) > 0): ?>
                            <?php foreach($products as $product): ?>
                                <div class="product-card" itemscope itemtype="https://schema.org/Product">
                                    ...
                                    // Add voltage badge
                                    $voltage = '';
                                    if(strpos($product['subcategory'], '48v') !== false) $voltage = '48V';
                                    elseif(strpos($product['subcategory'], '60v') !== false) $voltage = '60V';
                                    ?>
                                    <?php if($voltage): ?>
                                        <div class="voltage-badge"><?php echo $voltage; ?></div>
                                    <?php endif; ?>
                                    ...
                                    <img src="../<?php echo htmlspecialchars($product['image']); ?>" 
                                         ...
                                         itemprop="image"
                                         loading="lazy"
                                         onerror="this.src='https://via.placeholder.com/300x200?text=Battery+Image'">
                        ...
                        <?php else: ?>
                            <div class="no-products">
                                ...
                                <p>Try adjusting your filters or check back later for new power solutions</p>
                                <a href="battery.php" class="apply-filter-btn" style="display: inline-block; width: auto; padding: 10px 20px; margin-top: 20px;">Clear Filters</a>
                            </div>
                        <?php endif; ?>
                    </div>
